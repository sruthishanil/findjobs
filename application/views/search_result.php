	...
	<div class="banner-bottom">
		<div class="container">
			<div class="tittle_head_w3ls">
				<h3 class="tittle">Your results</h3>
			</div>
			<div class="inner_sec_grids_info_w3ls">
				...
				<p><span>Last date : </span><?php echo $row->last_date ?></p>
					...
					<ul style="list-style-type: none;">
						...
						<li   align="right" ><a href="<?php echo site_url();?>/Welcome/registration" style="background-color: #23B684; color: white ;" class="btn"><span class="icon_text">Apply to Job  <i class="fa fa-caret-right icon_1"> </i></span></a></li>
					</ul>
				</div>
 				<?php
				$i++;
