...
<head>
	<title>Soft a Human Resource Management Category Bootstrap Responsive Web Template | Upload :: w3layouts</title>
	<!--/tags -->
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<meta name="keywords" content="Soft Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEri<?php echo base_url();?>/assets/css/on, Motorola web design" />
	...
	<!--//tags -->
	<link href="<?php echo base_url();?>/assets/css//bootstrap.<?php echo base_url();?>/assets/css/" rel="stylesheet" type="text/<?php echo base_url();?>/assets/css/" media="all" />
	<link href="<?php echo base_url();?>/assets/css//style.<?php echo base_url();?>/assets/css/" rel="stylesheet" type="text/<?php echo base_url();?>/assets/css/" media="all" />

	<link href="<?php echo base_url();?>/assets/css//font-awesome.<?php echo base_url();?>/assets/css/" rel="stylesheet">
	<!-- //for bootstrap working -->
	<link href="//fonts.googleapis.com/<?php echo base_url();?>/assets/css/?family=Work+Sans:200,300,400,500,600,700" rel="stylesheet">
	<link href='//fonts.googleapis.com/<?php echo base_url();?>/assets/css/?family=Lato:400,100,100italic,300,300italic,400italic,700,900,900italic,700italic'
	    rel='stylesheet' type='text/<?php echo base_url();?>/assets/css/'>
</head>
